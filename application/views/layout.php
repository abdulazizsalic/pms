...
<head>
  ...
  <title>Property Management System • Digital Excellence Group</title>
  <!-- Bootstrap Core CSS -->
    ...
    <header class="topbar">
      <nav class="navbar top-navbar navbar-expand-md navbar-light">
        <div class="navbar-header">
          <?php echo anchor('.', '<b>
                <img src="assets/images/home-icon-silhouette.png" alt="homepage" class="dark-logo" style="height:35px;" />
                <img src="assets/images/logo-light-icon.png" alt="homepage" class="light-logo" />
            </b>
            <span>
               <img src="assets/images/logo-pms.png" alt="homepage" class="dark-logo" style="width:180px;" />
...
-->
            ...
            <li class="nav-item dropdown">
              <?php echo anchor('calendar', '<i class="mdi mdi-calendar"></i> <div class="notify"> </div>', 'class="nav-link text-muted waves-effect waves-dark" id="2" aria-haspopup="true" aria-expanded="false"'); ?>
              <!-- <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="#" id="2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="mdi mdi-calendar"></i>
          ...
          <ul class="navbar-nav my-lg-0">
            <li class="nav-item hidden-sm-down">
              <form class="app-search">
                <input type="text" class="form-control" id="search" onkeyup="myFunction()" name="search" placeholder="<?php echo ((uri_string() != " dashboard ") ? "Search in " . explode("/ ",uri_string())[0] : "Search for... ");?>"> <a class="srh-btn"><i class="ti-search"></i></a>

              </form>
            </li>
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <?php $session_image = $this->session->userdata('image'); ?>
                <?php $image = !empty($session_image) && file_exists('uploads/' . $session_image) ? $session_image : 'preview.jpg'; ?>
                <?php echo img(array('src' => 'uploads/' . $image, 'alt' => 'user', 'class' => 'profile-pic')); ?>
              </a>
                  ...
                  <li>
                    <div class="dw-user-box">
                      ...
                      <div class="u-text">
                        ...
                        <?php echo anchor('profile', 'View Profile', 'class="btn btn-rounded btn-danger btn-sm"'); ?>
                      </div>
                    </div>
                  </li>
                  <li role="separator" class="divider"></li>
                  <li>
                    <?php echo anchor('profile', '<i class="ti-user"></i> My Profile', ''); ?></li>
                  <li role="separator" class="divider"></li>
                  <li>
                    <?php echo anchor('settings', '<i class="ti-settings"></i> Account Setting', ''); ?></li>
                  <li role="separator" class="divider"></li>
                  <li>
                    <?php echo anchor('logout', '<i class="fa fa-power-off"></i> Logout', ''); ?></li>
                </ul>
              </div>
            </li>
            <li class="nav-item dropdown">
    ...
    <aside class="left-sidebar">
      ...
      <div class="scroll-sidebar">
        ...
        <div class="user-profile">
          ...
          <div class="profile-text">
            ...
            <div class="dropdown-menu animated flipInY">
              <?php echo anchor('profile', '<i class="ti-user"></i> My Profile', 'class="dropdown-item"'); ?>
              <div class="dropdown-divider"></div>
              <?php echo anchor('settings', '<i class="ti-settings"></i> Account Setting', 'class="dropdown-item"'); ?>
              <div class="dropdown-divider"></div>
              <?php echo anchor('logout', '<i class="fa fa-power-off"></i> Logout', 'class="dropdown-item"'); ?>
            </div>
          </div>
        </div>
        ...
        <nav class="sidebar-nav">
          <ul id="sidebarnav">
            ...
            <li>
              <a class="has-arrow " href="#" aria-expanded="false"><i class="mdi mdi-bullseye"></i><span class="hide-menu">Properties</span></a>
              <ul aria-expanded="false" class="collapse">
                <li>
                  <?php echo anchor('properties', 'Properties'); ?>
                </li>
                <li>
                  <?php echo anchor('units', 'Units'); ?>
                </li>
              </ul>
            </li>
            <li>
              <a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-chart-bubble"></i><span class="hide-menu">Accounting</span></a>
              <ul aria-expanded="false" class="collapse">
                <li>
                  <?php echo anchor('transactions', 'Invoices'); ?>
                </li>
              </ul>
            </li>
            <li>
              <a class="has-arrow " href="#" aria-expanded="false"><i class="mdi mdi-email"></i><span class="hide-menu">Contacts</span></a>
              <ul aria-expanded="false" class="collapse">
                <li>
            ...
            <li>
              <a class="has-arrow " href="#" aria-expanded="false"><i class="mdi mdi-table"></i><span class="hide-menu">Maintenance</span></a>
              <ul aria-expanded="false" class="collapse">
                <li>
                  <?php echo anchor('requests', 'Requests'); ?>
                </li>
              </ul>
            </li>
            <li>
              <?php echo anchor('reports', '<i class="mdi mdi-file"></i><span class="hide-menu">Reports</span>', ''); ?>
            </li>
      ...
      <div class="sidebar-footer">
        <?php echo anchor('settings', '<i class="ti-settings"></i>', 'class="link" data-toggle="tooltip" title="Settings"'); ?>
        <!-- <a href="#" class="link" data-toggle="tooltip" title="Email"><i class="mdi mdi-gmail"></i></a> -->
        <?php echo anchor('logout', '<i class="mdi mdi-power"></i>', 'class="link" data-toggle="tooltip" title="Logout"'); ?>
      </div>
      <!-- End Bottom points-->
    </aside>
    <!-- ============================================================== -->
    ...
    <div class="page-wrapper">
      ...
      <div class="container-fluid">
        ...
        <!-- INFO: Right side base was previously here -->
      ...
      <footer class="footer">
        <div class="container">
        ©
        <?php echo date('Y'); ?> PMS by www.digitalexcellencegroup.com
      </div>
      </footer>
      <!-- ============================================================== -->
      <!-- End footer -->
